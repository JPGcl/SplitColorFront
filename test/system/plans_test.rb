...
class PlansTest < ApplicationSystemTestCase
  ...
  test "should create plan" do
    ...
    check "Enabled" if @plan.enabled
    fill_in "Expiration date", with: @plan.expiration_date
    fill_in "Payment date", with: @plan.payment_date
    fill_in "Type plans", with: @plan.type_plans_id
